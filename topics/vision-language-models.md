...
FROM "papers"
WHERE contains(tags, "vision-language-models")
SORT year DESC
```
...
- **Rotation and perspective taking as diagnostic probes.** [[papers/2025/2025-spinbench/2025-spinbench|SpinBench]] (ICLR 2026) evaluates 43 VLMs on cognitively grounded spatial reasoning tasks, revealing that most models perform at or below chance on mental rotation and perspective taking. GPT-5 leads in both accuracy and consistency; controlled variations expose systematic egocentric bias (41% of models below chance on allocentric tasks) and reasoning inconsistency under logically equivalent reformulations.
