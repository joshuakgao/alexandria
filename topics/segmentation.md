...
*Last updated: 2026-06-01 | Sources: 5 papers*
...
1. **XMem** — Understand long-video memory challenges and hierarchical memory architectures (foundational temporal propagation)
2. **Cutie** — See how object-level memory reading improves on XMem's pixel matching; same authors, direct successor
3. **DEVA** — See how decoupling image segmentation from temporal propagation enables open-world video segmentation; uses XMem/Cutie as backbone
4. **SAM-Track** — Compare DEVA's automatic approach with interactive user-in-the-loop segmentation and tracking
5. **SAMURAI** — See how motion modeling and selective memory retention improve on SAM 2 for visual object tracking
